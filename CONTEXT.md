...
- Добавлен чекбокс "Даю согласие на обработку персональных данных"
  - Жёлтая рамка, при нажатии — жёлтый фон с чёрной ✓
  - Кнопка "ДАЛЕЕ" неактивна (disabled) пока галочка не поставлена

### Стрелка в выпадающем списке (select)

- Добавлена кастомная белая стрелка вниз в `.form-select` через SVG background-image
