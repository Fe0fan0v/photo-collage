...
class EmailService:
    ...
    def _build_message(self, to_email: str, image_bytes: bytes, customer_type: str = '') -> MIMEMultipart:
        ...
        # HTML body
        font = "'PT Sans Caption', Arial, Helvetica, sans-serif"
        html = f"""\
<html>
<head>
  <link href="https://fonts.googleapis.com/css2?family=PT+Sans+Caption:wght@400;700&display=swap" rel="stylesheet">
</head>
<body style="margin: 0; padding: 0; background-color: #000000; font-family: {font};">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #000000;">
          <tr>
            <td align="center" style="padding: 20px; background-color: #f0f0f0;">
              <a href="{homepage_url}" target="_blank" style="text-decoration: none; color: #000000; font-family: {font}; font-size: 16px; font-weight: bold; letter-spacing: 3px;">SELETTI &times; DELIGHT</a>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding: 40px 30px 16px 30px;">
              <h2 style="margin: 0; color: #ffffff; font-family: {font}; font-size: 24px; font-weight: bold;">Ваш Seletti Hybrid</h2>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding: 0 30px 40px 30px;">
              <p style="margin: 0; color: #cccccc; font-family: {font}; font-size: 14px; line-height: 1.6;">Все коллекции на официальном сайте <a href="{seletti_url}" target="_blank" style="color: #FFED00; text-decoration: none;">seletti.ru</a></p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding: 20px 30px; border-top: 1px solid #333333;">
              <p style="margin: 0; color: #666666; font-family: {font}; font-size: 11px;">Seletti Russia</p>
            </td>
          </tr>
        </table>
      </td>
